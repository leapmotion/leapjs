...
BrowserConnection.prototype.setupSocket = function() {
  ...
  try {
      ...
      /An insecure WebSocket connection may not be initiated from a page loaded over HTTPS/.test(qr.message) && alert("To enable Leap Motion Controller in your version of Google Chrome, follow these instructions:\n\n1. Go to chrome://flags/\n2. Search for \"Allow insecure WebSocket from https origin\"\n3. Click Enable.\n4. Click \"Relaunch Now\" in the bottom to restart Chrome.\n\nSorry for the inconvenience, we're working on a solution!");
  }
}
