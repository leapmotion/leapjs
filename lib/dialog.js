...
Dialog.warnOutOfDate = function(params){
  ...
  var dialog,
    ...
    message = "This site requires Leap Motion Tracking Beta, now available for developers." +
      "<button id='leapjs-accept-upgrade'  style='color: #444; transition: box-shadow 100ms linear; cursor: pointer; margin-left: 16px; '>Upgrade</button>" +
      "<button id='leapjs-decline-upgrade' style='color: #444; transition: box-shadow 100ms linear; cursor: pointer; margin-left: 8px; '>Not Now</button>";
